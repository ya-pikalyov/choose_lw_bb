...
from src.bb.edgeformer.cvnets.utils import logger
from src.bb.edgeformer.cvnets.misc.common import parameter_list
from src.bb.edgeformer.cvnets.layers import norm_layers_tuple
from src.bb.edgeformer.cvnets.misc.profiler import module_profile
from src.bb.edgeformer.cvnets.misc.init_utils import initialize_weights
...
class BaseEncoder(nn.Module):
    ...
    def extract_end_points_l4(self, x: Tensor) -> Dict:
        return self.extract_end_points_all(x, use_l5=True)
